  ...
  return (
    ...
    >
      ...
      <div className="fixed flex flex-wrap bottom-12 justify-center inset-x-0 px-2">
        ...
        <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white rounded-3xl px-2 py-3">
...
<button onClick={()=>setColor("violet")} className="outline-none px-4 py-1 rounded-full text-white"
          style={{backgroundColor:"violet"}}>Violet</button>

<button onClick={()=>setColor("orange")} className="outline-none px-4 py-1 rounded-full text-white"
          style={{backgroundColor:"orange"}}>Orange</button>

<button onClick={()=>setColor("salmon")} className="outline-none px-4 py-1 rounded-full text-white"
